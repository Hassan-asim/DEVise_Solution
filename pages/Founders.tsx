...
const FounderCard: React.FC<{ founder: typeof FOUNDERS[0] }> = ({ founder }) => {
  return (
    <div className="group text-center p-6 bg-light-bg-secondary dark:bg-dark-bg-secondary rounded-lg shadow-lg transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary-DEFAULT/40 dark:hover:shadow-secondary-DEFAULT/30">
      <img
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
      <AnimatedSection className="text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Our Founders</h1>
